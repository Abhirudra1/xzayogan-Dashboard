    ...
    return (
        <div className={`flex h-screen relative ${isDarkMode ? 'bg-gray-900 text-white' : 'bg-white text-black'}`}>
            ...
            <div className="absolute top-4 right-4 flex items-center space-x-4">
                ...
                />
                <img
                    src={user?.picture || "https://storage.googleapis.com/a1aa/image/t66-YXQzhLkxIrcpjLgymzDx1YbYwIqm_WVG9-aro04.jpg"}
                    alt="Profile picture"
                    className="w-10 h-10 rounded-full"
                    width="40"
                    height="40"
                />
                <button onClick={onLogout} className="text-sm text-blue-500 hover:underline">
                    Logout
                </button>
            </div>
